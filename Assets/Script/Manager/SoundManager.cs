...
public class SoundManager
{
    ...
    {
        Left = Resources.Load<AudioClip>("Sound/UI/BtnLeft");
        Right = Resources.Load<AudioClip>("Sound/UI/BtnRight");
    ...
    // 버튼 클릭시 효과음재생
    public void PlayBtn(Define.Mouse m)
    {
        switch (m)
        {
            case Define.Mouse.ClickL: FX.clip = Left; FX.Play(); break;
            case Define.Mouse.ClickR: FX.clip = Right; FX.Play(); break;
            default: break;
        }
    }
